export class HoarderAPI {
	...
	async getListBookmarks(id, params = {}) {
		...
		return this.request(`/api/v1/lists/${id}/bookmarks`, {
			params: queryParams,
		});
	}
	...
	async reorderBookmarkInList(listId, bookmarkId, targetId, position) {
		return this.request(
			`/api/v1/lists/${listId}/bookmarks/${bookmarkId}/reorder`,
			{
				method: "PUT",
				body: {
					targetId,
	...
	async getTagBookmarks(id, params = {}) {
		...
		return this.request(`/api/v1/tags/${id}/bookmarks`, {
			params: queryParams,
		});
	}
	...
	async replaceBookmarkAsset(bookmarkId, oldAssetId, newAssetId) {
		return this.request(
			`/api/v1/bookmarks/${bookmarkId}/assets/${oldAssetId}`,
			{
				method: "PUT",
	...
	async getBookmarkHighlights(bookmarkId, params = {}) {
		...
		return this.request(`/api/v1/bookmarks/${bookmarkId}/highlights`, {
			params: queryParams,
		});
	}
