...
export class SearchBar extends HTMLElement {
    ...
    setupEventListeners() {
        ...
        const suggestionsContainer = this.shadowRoot.querySelector('.search-suggestions');
        ...
        this.shadowRoot.querySelector('.advanced-search-btn')
    ...
    hideSuggestions() {
        this.shadowRoot.querySelector('.search-suggestions').classList.add('hidden');
        this.selectedSuggestionIndex = -1;
    }
                    ...
                    <div id="search-tags" class="tag-selector">
                        ${state.tags.map(tag => `
                            <div class="selector-item${
                                advancedSearch.selectedTags.includes(tag.id) ? ' selected' : ''
                            }" data-id="${tag.id}">
                                ${tag.name}
                            </div>
                        `).join('')}
                ...
                <div class="form-group">
                    ...
                    <div id="search-lists" class="list-selector">
                        ${state.lists.map(list => `
                            <div class="selector-item${
                                advancedSearch.selectedLists.includes(list.id) ? ' selected' : ''
                            }" data-id="${list.id}">
                                ${list.name}
                            </div>
                        `).join('')}
                    ...
                    <div class="form-group">
                        ...
                        <select id="sort-by">
                            <option value="createdAt"${
                                advancedSearch.sortBy === 'createdAt' ? ' selected' : ''
                            }>Created Date</option>
                            <option value="updatedAt"${
                                advancedSearch.sortBy === 'updatedAt' ? ' selected' : ''
                            }>Updated Date</option>
                            <option value="title"${
                                advancedSearch.sortBy === 'title' ? ' selected' : ''
                            }>Title</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select id="sort-order">
                            <option value="desc"${
                                advancedSearch.sortOrder === 'desc' ? ' selected' : ''
                            }>Descending</option>
                            <option value="asc"${
                                advancedSearch.sortOrder === 'asc' ? ' selected' : ''
                            }>Ascending</option>
                        </select>
                    </div>
                </div>
